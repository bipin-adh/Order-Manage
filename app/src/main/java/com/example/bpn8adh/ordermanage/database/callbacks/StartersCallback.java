...
/**
 * Created by bpn8adh on 17/03/18.
 */

public class StartersCallback implements ValueEventListener {

    public static final String TAG = StartersCallback.class.getSimpleName();
    private final UiUpdateListener uiUpdateListener;
    private List<FoodDetails> foodDetailsList = new ArrayList<>();

    public StartersCallback(UiUpdateListener uiUpdateListener) {
    ...
    public void onDataChange(DataSnapshot dataSnapshot) {
        ...
        if (dataSnapshot != null) {
            ...
            AppSettings.getInstance().setStartersDetailsLists(foodDetailsList);
